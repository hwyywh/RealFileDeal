...
public class filtGPS {//通过过滤GPS划分出矩形区域

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		multiProcessData("D:\\taxi\\Taxi_070220\\");
...
//这个模块是读取目标文件每一行             
        	...
        	while ((line1 = br1.readLine()) != null){        		         		 
                 ...
                 //满足GPS的范围的数据存入文档
                 if(Double.parseDouble(se1[2])>=121.4632&&Double.parseDouble(se1[2])<=121.4864&&Double.parseDouble(se1[3])>=31.2480&&Double.parseDouble(se1[3])<=31.2668)
                 ReadFromFile.writeFile("D:\\r=200-44\\88\\"+file.getName(), line1+'\n');      
